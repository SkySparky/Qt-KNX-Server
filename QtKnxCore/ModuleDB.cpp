...
ModuleDB::ModuleDB(QString  sqlName, QString  dbName, QString  dbHostName, QString  dbUserName, QString  dbPassword)
{
	m_dbName = dbName;
    ...
    m_db = QSqlDatabase::addDatabase("QSQLITE", m_sqlName);

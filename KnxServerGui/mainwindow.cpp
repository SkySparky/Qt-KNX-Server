...
void MainWindow::on_btnStart_clicked()
{
    if (ui->btnStart->text() == "Start") {
        ...
        m_knxserver->Bind();
        connect(m_knxserver, SIGNAL(Log(QString,QString)), this, SLOT(onServerLog(QString,QString)), Qt::DirectConnection);
        connect(m_knxserver, SIGNAL(GatewayData(QString,QString)), this, SLOT(onServerData(QString,QString)), Qt::DirectConnection);
        connect(this, SIGNAL(SendDataToServer(QString,QString,QString)), m_knxserver, SLOT(onSendDataToClients(QString,QString,QString)), Qt::DirectConnection);
    }
    else {
